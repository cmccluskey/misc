...
def build_file_tree(items=[], recurse)
  temp_dict = {}
...
parser.add_argument('-o', dest='unixoffend', action='store_true', default=False, help='Remove typically offending Unix shell characters')
